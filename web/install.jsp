...
private List<String> resetDatabase(boolean force) throws Exception {
        ...
        String data[] = new String[]{
            ...
            "INSERT INTO " + dbname + ".professors (username,password,nomcomplet) VALUES ('oscar','123','Oscar Lorite Jódar')",
            "INSERT INTO " + dbname + ".professors (username,password,nomcomplet) VALUES ('oriol','321','Oriol Buqueras Solsona')",};
